...
ai-service/.venv/bin/python -m pytest ai-service/tests scripts/tests -q
...
android-app/gradlew -p android-app :core:test :app:assembleDebug :app:assembleDebugAndroidTest :app:lintDebug
